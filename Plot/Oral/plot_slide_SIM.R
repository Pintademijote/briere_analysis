...
p1=ggplot(data=data_ALL[data_ALL$Simu==c("TIB", "TTIB"),],aes(x=Distance, y=Modularity, color=Simu))+geom_point(data=data_ALL[data_ALL$Simu==c("TIB", "TTIB"),],aes(x=Distance, y=Modularity,shape = Simu), size = 4, alpha=0.8) +
  ...
  scale_color_manual(values=c("tomato1", "#cccc00")) +   scale_linetype_manual(values = c("dashed","dashed","solid"))+
...
p3=ggplot(data=data_ALL[data_ALL$Simu==c("TIB", "TTIB"),],aes(x=Distance, y=n, color=Simu))+
  geom_point(data=data_ALL[data_ALL$Simu==c("TIB", "TTIB"),],aes(x=Distance, y=n, shape = Simu), size = 4, alpha=0.8) +
...
p5=ggplot(data=data_ALL[data_ALL$Simu==c("TIB", "TTIB"),],aes(x=Distance, y=Mean_trophic_level, color=Simu))+
  geom_point(data=data_ALL[data_ALL$Simu==c("TIB", "TTIB"),],aes(x=Distance, y=Mean_trophic_level, shape = Simu), size = 4, alpha=0.8) +
...
p7=ggplot(data=data_ALL[data_ALL$Simu==c("TIB", "TTIB"),],aes(x=Distance, y=Mean_Omnivory_Index, color=Simu))+
  geom_point(data=data_ALL[data_ALL$Simu==c("TIB", "TTIB"),],aes(x=Distance, y=Mean_Omnivory_Index,shape = Simu), size = 4, alpha=0.8) +
  ...
  scale_shape_manual(values=c(17,15))+
  scale_color_manual(values=c("tomato1", "#cccc00")) +   scale_linetype_manual(values = c("solid","dashed","dashed"))+
  scale_x_continuous(breaks = seq(0, 2500, by = 500), labels= seq(0, 2500, by = 500))+
...
p4=ggplot(data=data_ALL[data_ALL$Simu==c("TIB", "TTIB"),], aes(x=log(Surface), y=n, color=Simu)) +
...
p6=ggplot(data=data_ALL[data_ALL$Simu==c("TIB", "TTIB"),], aes(x=log(Surface), y=n, color=Simu)) +
  geom_point(data=data_ALL[data_ALL$Simu==c("TIB", "TTIB"),],aes(x=log(Surface), y=Mean_trophic_level,shape = Simu), size = 4, alpha=0.8) +
...
p8=ggplot(data=data_ALL[data_ALL$Simu==c("TIB", "TTIB"),], aes(x=log(Surface), y=n, color=Simu)) +
  geom_point(data=data_ALL[data_ALL$Simu==c("TIB", "TTIB"),],aes(x=log(Surface), y=Mean_Omnivory_Index,shape = Simu), size = 4, alpha=0.8) +
...
p2=ggplot(data=data_ALL[data_ALL$Simu==c("TIB", "TTIB"),], aes(x=log(Surface), y=n, color=Simu)) +
  geom_point(data=data_ALL[data_ALL$Simu==c("TIB", "TTIB"),],aes(x=log(Surface), y=Modularity,shape = Simu), size = 4, alpha=0.8) +
